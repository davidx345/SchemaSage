...
export default function SettingsPage() {
  ...
  return (
    <div className="relative flex min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
            ...
            <div className="max-w-5xl mx-auto space-y-8">
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                <TabsList className="grid grid-cols-3 glass border-divider">
                  <TabsTrigger value="general" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground font-semibold text-lg transition-all">General</TabsTrigger>
                  <TabsTrigger value="api" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground font-semibold text-lg transition-all">API Keys</TabsTrigger>
                  <TabsTrigger value="schema" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground font-semibold text-lg transition-all">Schema Preferences</TabsTrigger>
                </TabsList>
                <form onSubmit={form.handleSubmit(onSubmit)}>
                  <TabsContent value="general" className="space-y-6">
                    <Card className="card shadow-card hover:shadow-xl transition-shadow duration-300">
                      <CardHeader>
                      ...
                      <CardContent className="space-y-6">
                        ...
                        </div> {/* <-- closes the div for theme select */}
                        ...
                        </div> {/* closes Export/Import Settings wrapper */}
                        <Separator className="bg-divider" />
                        <div className="space-y-4">
                          <div>
                            <h3 className="text-lg font-medium">Advanced Settings</h3>
                            <p className="text-sm text-muted-foreground mt-1">
                              Configure advanced options for schema detection and code generation
                            </p>
                          </div>
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="flex gap-2">
                                <Input
                                  ...
                                  className="flex-1 bg-muted focus:ring-2 focus:ring-primary focus:outline-none transition-all"
                                />
                              </div>
                          ...
                          <div className="flex items-center justify-between p-4 rounded-lg bg-muted border border-divider">
                            ...
                            <Switch id="streaming" defaultChecked className="focus:ring-2 focus:ring-primary focus:outline-none transition-all" />
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                  ...
                  <TabsContent value="api" className="space-y-6">
                    <Card className="card shadow-card hover:shadow-xl transition-shadow duration-300">
                      ...
                      <CardContent className="space-y-6">
                        ...
                        </div> {/* closes AI Provider Settings wrapper */}
                        <Separator className="bg-divider" />
                        <div className="space-y-4">
                          <div>
                            <h3 className="text-lg font-medium">Advanced Settings</h3>
                  ...
                  <TabsContent value="schema" className="space-y-6">
                    ...
                    <div className="mt-8 flex justify-end">
                      <Button 
                        type="submit" 
                        className="flex gap-2 items-center cta focus:ring-2 focus:ring-primary focus:outline-none transition-all"
                      >
