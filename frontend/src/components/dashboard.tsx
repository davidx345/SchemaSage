      ...
      <TooltipProvider>
        <div className="min-h-screen bg-background relative overflow-hidden">
          ...
          <Dialog open={newProjectDialog} onOpenChange={setNewProjectDialog}>
            <DialogContent
              className="modal-content-override bg-[#fff] text-[#111] border border-border shadow-2xl dark:bg-neutral-900 dark:text-white"
            >
              <DialogHeader>
              ...
              <div className="space-y-6 py-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-[#fff] text-[#111] dark:bg-neutral-900 dark:text-white border border-border placeholder:text-muted-foreground focus:border-primary focus:ring-primary/20 rounded-xl"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="bg-[#fff] text-[#111] dark:bg-neutral-900 dark:text-white border border-border placeholder:text-muted-foreground focus:border-primary focus:ring-primary/20 rounded-xl min-h-[100px]"
                  />
                </div>
              </div>
              <DialogFooter>
