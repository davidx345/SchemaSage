...
# Include Phase 1 Week 2 routers
from routers.migration_timeline import router as migration_timeline_router
app.include_router(migration_timeline_router)
...
# Include Deployment Analysis router (new feature)
